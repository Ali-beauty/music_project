...
<form action="UserServlet" method="get" class="definewidth m20">
    ...
    <table class="table table-bordered table-hover definewidth m10">
        ...
        <tr>
            ...
            <td><input type="password" name="password" value="<%=user.getUser_pwd()%>"/></td>
        </tr>
        <tr>
            <td class="tableleft">性别</td>
            <td><input type="text" name="realname" value="<%=user.getUser_gender()%>"/></td>
        </tr>
        <tr>
            <td class="tableleft">邮箱</td>
            <td><input type="text" name="email" value="<%=user.getUser_mail()%>"/></td>
        </tr>
        <tr>
